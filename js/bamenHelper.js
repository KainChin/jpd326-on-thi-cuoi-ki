/**
 * Bamen Render Helper (Supports Bamen 1 & Bamen 2)
 * Strictly modularized < 250 lines
 */
window.BamenHelper = (function() {
  function renderBamen1() {
  ...
  return { renderBamen1, renderBamen2 };
})();
